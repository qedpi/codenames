    ...
    render() {
        ...
        const hint_history = (
            <Drawer open={this.state.show_drawer}>
                <MenuItem>Hint History</MenuItem>
        ...
        const hintControls = this.state.gameStatus === 'playing' ?
            (
                <div style={{display: 'inline-block'}}>
                    <RaisedButton
                        label="History"
                        onClick={() => this.setState({show_drawer: !this.state.show_drawer})}/>
                    <RaisedButton label='Next Hint' onClick={this.handleSubmit} primary={true}
